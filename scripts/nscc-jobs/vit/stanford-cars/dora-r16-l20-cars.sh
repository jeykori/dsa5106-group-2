...
# r=16, alpha=32, learning_rate=2e-3
# -------------------------------------------------------------------

#PBS -P personal
#PBS -N DoRA_ViT-p16-224_r16-l20-stanford_cars
#PBS -q normal
#PBS -l select=1:ngpus=1
#PBS -l walltime=4:00:00
#PBS -j oe
#PBS -o dora-vit-r16-l20-stanford_cars.txt
...
LORA_ALPHA=32
LEARNING_RATE="2e-3"
NAME="DoRA-ViT-p16-224-r16-l20-$DATASET"
OUT_DIR="$HOME/scratch/vit/dora-vit-r16-l20-$DATASET"
