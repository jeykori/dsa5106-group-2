...
# r=16, alpha=32, learning_rate=1.5e-3
# -------------------------------------------------------------------

#PBS -P personal
#PBS -N LoRA_ViT-p16-224_r16-l15-stanford_cars
#PBS -q normal
#PBS -l select=1:ngpus=1
#PBS -l walltime=4:00:00
#PBS -j oe
#PBS -o lora-vit-r16-l15-stanford_cars.txt
...
NAME="LoRA-ViT-p16-224-r16-l15-$DATASET"
OUT_DIR="$HOME/scratch/vit/lora-vit-r16-l15-$DATASET"
