...
#PBS -P personal
#PBS -N LoRA_ViT-p16-224_r16-l3-stanford_cars
#PBS -q normal
#PBS -l select=1:ngpus=1
#PBS -l walltime=4:00:00
#PBS -j oe
#PBS -o lora-vit-r16-l3-stanford_cars.txt
...
LORA_ALPHA=32
LEARNING_RATE="3e-4"
NAME="LoRA-ViT-p16-224-r16-l3-$DATASET"
OUT_DIR="$HOME/scratch/vit/lora-vit-r16-l3-$DATASET"
