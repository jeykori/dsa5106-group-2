...
# r=32, alpha=64, learning_rate=9e-4
# -------------------------------------------------------------------

#PBS -P personal
#PBS -N DoRA_ViT-p16-224_r32-l9-oxford_flowers
#PBS -q normal
#PBS -l select=1:ngpus=1
#PBS -l walltime=4:00:00
#PBS -j oe
#PBS -o dora-vit-r32-l9-oxford_flowers.txt
...
LORA_ALPHA=64
LEARNING_RATE="9e-4"
NAME="DoRA-ViT-p16-224-r32-l9-$DATASET"
OUT_DIR="$HOME/scratch/vit/dora-vit-r32-l9-$DATASET"
