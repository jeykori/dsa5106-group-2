...
# r=16, alpha=32, learning_rate=6e-4
# -------------------------------------------------------------------

#PBS -P personal
#PBS -N DoRA_ViT-p16-224_r16-l6-oxford_flowers
#PBS -q normal
#PBS -l select=1:ngpus=1
#PBS -l walltime=4:00:00
#PBS -j oe
#PBS -o dora-vit-r16-l6-oxford_flowers.txt
...
LORA_ALPHA=32
LEARNING_RATE="6e-4"
NAME="DoRA-ViT-p16-224-r16-l6-$DATASET"
OUT_DIR="$HOME/scratch/vit/dora-vit-r16-l6-$DATASET"
