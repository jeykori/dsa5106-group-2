...
#PBS -P personal
#PBS -N LoRA_ViT-p16-224_r32-l2-oxford_flowers
#PBS -q normal
#PBS -l select=1:ngpus=1
#PBS -l walltime=4:00:00
#PBS -j oe
#PBS -o lora-vit-r32-l2-oxford_flowers.txt
...
LORA_ALPHA=64
LEARNING_RATE="2e-4"
NAME="LoRA-ViT-p16-224-r32-l2-$DATASET"
OUT_DIR="$HOME/scratch/vit/lora-vit-r32-l2-$DATASET"
