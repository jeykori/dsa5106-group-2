...
#PBS -P personal
#PBS -N DoRA_ViT-p16-224_r16-l2-oxford_flowers
#PBS -q normal
#PBS -l select=1:ngpus=1
#PBS -l walltime=4:00:00
#PBS -j oe
#PBS -o dora-vit-r16-l2-oxford_flowers.txt
...
LORA_ALPHA=32
LEARNING_RATE="2e-4"
NAME="DoRA-ViT-p16-224-r16-l2-$DATASET"
OUT_DIR="$HOME/scratch/vit/dora-vit-r16-l2-$DATASET"
