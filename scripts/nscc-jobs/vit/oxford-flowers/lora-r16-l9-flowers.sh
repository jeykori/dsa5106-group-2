...
#PBS -P personal
#PBS -N LoRA_ViT-p16-224_r16-l9-oxford_flowers
#PBS -q normal
#PBS -l select=1:ngpus=1
#PBS -l walltime=4:00:00
#PBS -j oe
#PBS -o lora-vit-r16-l9-oxford_flowers.txt
...
LORA_ALPHA=32
LEARNING_RATE="9e-4"
NAME="LoRA-ViT-p16-224-r16-l9-$DATASET"
OUT_DIR="$HOME/scratch/vit/lora-vit-r16-l9-$DATASET"
