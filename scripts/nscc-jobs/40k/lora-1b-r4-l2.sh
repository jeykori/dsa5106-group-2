...
# -------------------------------------------------------------------
# LoRA
# r=4, alpha=8, learning_rate=2e-4, sample_size=40k
# -------------------------------------------------------------------

#PBS -P personal
#PBS -N LoRA_LLaMA_3.2_1B_r4-l2-40k
#PBS -q normal
#PBS -l select=1:ngpus=1
#PBS -l walltime=4:00:00
#PBS -j oe
#PBS -o lora-1b-r4-l2-40k.txt
...
LORA_ALPHA=8
LEARNING_RATE="2e-4"
NAME="LoRA-1b-r4-l2-40k"
OUT_DIR="$HOME/scratch/commonsense_reasoning/40k/lora-1b-r4-l2-40k"
