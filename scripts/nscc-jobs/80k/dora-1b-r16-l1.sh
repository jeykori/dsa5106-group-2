...
#PBS -P personal
#PBS -N DoRA_LLaMA_3.2_1B_r16-l1-80k
#PBS -q normal
#PBS -l select=1:ngpus=1
#PBS -l walltime=6:00:00
#PBS -j oe
#PBS -o dora-1b-r16-l1-80k.txt
...
LORA_ALPHA=32
LEARNING_RATE="1e-4"
NAME="DoRA-1b-r16-l1-80k"
OUT_DIR="$HOME/scratch/commonsense_reasoning/80k/dora-1b-r16-l1-80k"
