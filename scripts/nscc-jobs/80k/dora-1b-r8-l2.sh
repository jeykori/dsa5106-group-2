...
# -------------------------------------------------------------------
# DoRA
# r=8, alpha=16, learning_rate=2e-4, sample_size=80k
# -------------------------------------------------------------------

#PBS -P personal
#PBS -N DoRA_LLaMA_3.2_1B_r8-l2-80k
#PBS -q normal
#PBS -l select=1:ngpus=1
#PBS -l walltime=5:00:00
#PBS -j oe
#PBS -o dora-1b-r8-l2-80k.txt
...
LORA_ALPHA=16
LEARNING_RATE="2e-4"
NAME="DoRA-1b-r8-l2-80k"
OUT_DIR="$HOME/scratch/commonsense_reasoning/80k/dora-1b-r8-l2-80k"
