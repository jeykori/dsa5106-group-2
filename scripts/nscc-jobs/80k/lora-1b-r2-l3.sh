...
# -------------------------------------------------------------------
# LoRA
# r=2, alpha=4, learning_rate=3e-4, sample_size=80k
# -------------------------------------------------------------------

#PBS -P personal
#PBS -N LoRA_LLaMA_3.2_1B_r2-l3-80k
#PBS -q normal
#PBS -l select=1:ngpus=1
#PBS -l walltime=4:00:00
#PBS -j oe
#PBS -o lora-1b-r2-l3-80k.txt
...
LORA_ALPHA=4
LEARNING_RATE="3e-4"
NAME="LoRA-1b-r2-l3-80k"
OUT_DIR="$HOME/scratch/commonsense_reasoning/80k/lora-1b-r2-l3-80k"
